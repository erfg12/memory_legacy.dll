...
namespace Memory
{
    public class MemRead : Imps
    {
        ...
        public byte[] ReadBytes(string code, long length, string file)
        {
            ...
            if (!ReadProcessMemory(m.mProc.Handle, theCode, memory, (UIntPtr)length, IntPtr.Zero))
                return null;
        ...
        /// <returns></returns>
        public float ReadFloat(string code, string file, bool round)
        {
            ...
            try
            {
                if (ReadProcessMemory(m.mProc.Handle, theCode, memory, (UIntPtr)4, IntPtr.Zero))
                {
        ...
        /// <param name="code">address, module + pointer + offset, module + offset OR label in .ini file.</param>
        /// <param name="file">path and name of ini file. (OPTIONAL)</param>
        /// <param name="length">length of bytes to read (set to 32)</param>
        ...
        /// <returns></returns>
        public string ReadString(string code, string file, int length, bool zeroTerminated, System.Text.Encoding stringEncoding)
        {
            ...
            if (ReadProcessMemory(m.mProc.Handle, theCode, memoryNormal, (UIntPtr)length, IntPtr.Zero))
        ...
        /// <param name="round">Round the value to 2 decimal places</param>
        /// <returns></returns>
        public double ReadDouble(string code, string file, bool round)
        {
            ...
            try
            {
                if (ReadProcessMemory(m.mProc.Handle, theCode, memory, (UIntPtr)8, IntPtr.Zero))
                {
        ...
        {
            byte[] memory = new byte[4];
            if (ReadProcessMemory(m.mProc.Handle, code, memory, (UIntPtr)4, IntPtr.Zero))
        ...
        public int Read2ByteMove(string code, int moveQty, string file)
        {
            ...
            if (ReadProcessMemory(m.mProc.Handle, newCode, memory, (UIntPtr)2, IntPtr.Zero))
                return BitConverter.ToInt32(memory, 0);
            else
                return 0;
        }
        ...
        public int ReadIntMove(string code, int moveQty, string file)
        {
            ...
            if (ReadProcessMemory(m.mProc.Handle, newCode, memory, (UIntPtr)4, IntPtr.Zero))
                return BitConverter.ToInt32(memory, 0);
            else
                return 0;
        }
        ...
        public ulong ReadUIntMove(string code, int moveQty, string file)
        {
            ...
            if (ReadProcessMemory(m.mProc.Handle, newCode, memory, (UIntPtr)8, IntPtr.Zero))
        ...
        public int Read2Byte(string code, string file)
        {
            ...
            if (ReadProcessMemory(m.mProc.Handle, theCode, memoryTiny, (UIntPtr)2, IntPtr.Zero))
        ...
        public int ReadByte(string code, string file)
        {
            ...
            if (ReadProcessMemory(m.mProc.Handle, theCode, memoryTiny, (UIntPtr)1, IntPtr.Zero))
                return memoryTiny[0];
        ...
        public bool[] ReadBits(string code, string file)
        {
            ...
            if (!ReadProcessMemory(m.mProc.Handle, theCode, buf, (UIntPtr)1, IntPtr.Zero))
                return ret;
        ...
        {
            byte[] memory = new byte[4];
            if (ReadProcessMemory(m.mProc.Handle, (UIntPtr)(Convert.ToInt32(address) + m.LoadIntCode(code, file)), memory, (UIntPtr)1, IntPtr.Zero))
                return BitConverter.ToInt32(memory, 0);
            else
                return 0;
        }
        ...
        {
            byte[] memory = new byte[4];
            if (ReadProcessMemory(m.mProc.Handle, (UIntPtr)(Convert.ToInt32(address) + m.LoadIntCode(code, file)), memory, (UIntPtr)4, IntPtr.Zero))
            {
        ...
        public string ReadPString(UIntPtr address, string code, string file)
        {
            ...
            if (ReadProcessMemory(m.mProc.Handle, (UIntPtr)(Convert.ToInt32(address) + m.LoadIntCode(code, file)), memoryNormal, (UIntPtr)32, IntPtr.Zero))
